...
\todo{I still think that this synopsis/index section is useful, but I
  do not know how this should be integrated as a section in the manual.}

\subsection*{Parameters} \todo{replace the standard Coq stuff with the
appropriate macros.}
